...
exports.XDomainRequestClient = undefined;
...
var XDomainRequestClient = exports.XDomainRequestClient = function () {
  function XDomainRequestClient(proxyLocation) {
    var _this = this;
    ...
    this.iframeReady = new _promisePolyfill2.default(function (resolve) {
  ...
  _createClass(XDomainRequestClient, [{
    key: 'sendRequest',
    value: function sendRequest(options) {
      var _this2 = this;

      return this.iframeReady.then(function () {
        var requestId = _this2.correlationId++;
        var message = {
          requestId: requestId,
        ...
        return new _promisePolyfill2.default(function (resolve, reject) {
          _this2.contextByRequestId[requestId] = {
            resolve: resolve,
            reject: reject
          };

          try {
            _this2.iframe.contentWindow.postMessage(message, _this2.proxyLocation);
          } catch (err) {
            reject(err);
          }
        });
...
function buildUrl(baseUrl, path, params) {
  ...
  for (var key in params) {
    if (params.hasOwnProperty(key)) {
      value = _typeof(params[key]) === 'object' ? JSON.stringify(params[key]) : params[key];
